...
<table><tr><th>Name</th><th>Provider</th><th>Model id</th><th>Endpoint</th><th>Key</th><th>Max out</th><th>Notes</th><th></th></tr>
{{range .D}}<tr>
...
</tr>{{else}}<tr><td colspan=8 class=mut>No models registered — agents run on the legacy env config
